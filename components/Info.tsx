...
const Info = ({ isInfo }: { isInfo: boolean }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full md:items-stretch md:flex-row">
      {isInfo ? (
        <div className="break-inside mx-3 relative overflow-hidden w-[17rem] md:w-[40rem] flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-green-800 text-white">
          <span className="text-xs text-green-200 uppercase">Agroécologie</span>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="flex items-center justify-center px-4 py-2 space-x-1 text-xs font-medium text-black bg-white rounded-full">
              <span>Voir</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
        ...
        <div className="break-inside mx-3 relative w-[17rem] md:w-[40rem] overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-white text-black dark:bg-slate-800 border border-gray-300 dark:text-white">
          <div className="flex items-center justify-between font-medium">
            <span className="text-xs text-green-500 uppercase">
              Youssoufou Laouali
            </span>
            <span className="text-xs text-slate-500">#chef personnel</span>
          </div>
          <div className="flex flex-row items-center space-x-3">
            <div className="flex items-center justify-center flex-none w-10 h-10 text-white bg-green-700 rounded-full">
              <img
            ...
            <span className="text-base font-medium">
              Titre Fichier: Titre Fichier Titre Fichier Titre Fichier
            </span>
          </div>
          <div>
            {" "}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <dd className="flex justify-start -space-x-1.5">
                <a href="#" className="inline-block -m-1">
                  <img
                    className="rounded-full w-7 h-7 ring-2 ring-white dark:ring-slate-800"
                    src="https://randomuser.me/api/portraits/women/46.jpg"
                    alt="avatar"
                  />
                </a>
            ...
            <button className="flex items-center justify-center px-4 py-1 space-x-1 text-xs font-medium text-black bg-white border-2 border-black rounded-full hover:bg-black hover:text-white dark:bg-slate-800 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black">
              <span>Voir</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
