...
const SignUp = () => {
  ...
  const handleSubmit = () => {
    let err = "";
    if (data.name == "") err = "Veuillez ajouter votre nom";
    if (data.email == "") err = "Veuiller ajouter votre email";
    if (data.password == "") err = "Veuiller ajouter un mot de passe";
    ...
    if (err == "") {
      ...
      axios
        .post(url_api + "/auth/register", payload)
        .then((res) => {
          console.log(res);
          toast.success(
            res.data?.message ?? "L'utilisateur est créer avec succéss"
          );
          toast.success("Consulter votre email pour valider votre compte");
        ...
        <div className="flex flex-col items-center flex-auto min-w-0 bg-white sm:flex-row md:items-start sm:justify-center md:justify-start">
          ...
          >
            ...
            >
              ...
              />
              <p className="flex items-center ml-3 text-3xl">
                MOORIBEN <strong className="inline-block p-5">NIGER</strong>
              </p>{" "}
            </a>
            <img
              src="https://cdn.pixabay.com/photo/2014/12/21/23/33/cabbage-575525_960_720.png"
              className="absolute mr-5 h-96 right-5"
            />
            <div className="z-10 w-full max-w-md">
              <div className="mb-6 font-bold leading-tight sm:text-4xl xl:text-5xl">
                Créer un compte MOORIBEN
              </div>
            ...
            <div className="w-full max-w-md space-y-8">
              ...
              >
                ...
                <div className="content-center mt-8">
                  ...
                  <input
                    className="content-center w-full px-4 py-2 text-sm border-b border-gray-300 rounded-2xl focus:outline-none focus:border-green-500"
                    placeholder="Ali Issa"
                    onChange={(e) =>
                      setData({
                        ...data,
                        name: e.target.value,
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember_me"
                      type="checkbox"
                      className="w-4 h-4 bg-green-500 border-gray-300 rounded focus:ring-green-400"
                    />
                    <label
                      htmlFor="remember_me"
                  ...
                  <div className="text-sm">
                    <a href="#" className="text-blue-400 hover:text-green-500">
                      Mot de passe oublié?
                    </a>
                  </div>
                </div>
